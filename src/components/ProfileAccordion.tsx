...
const AccordionComponent = () => {
  ...
  const { mobileScreenOnly } = useScreenBreakpoints();
  ...
  return (
    <Box
      sx={{
        ...
        alignItems: mobileScreenOnly ? 'center' : 'flex-start',
      }}
    >
      <div
        style={{
        ...
        <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
          ...
          <AccordionDetails>
            <Typography mt={-2} sx={{ fontSize: 14 }}>
              ...
              projects and efficiently delivering quality results. Pivoted to software development
              in 2020, inspired by a passion for technology after collaborating with engineering
              teams in financial services. Skilled in using modern frontend frameworks and toolsets
        ...
        <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
          ...
          <AccordionDetails>
            <Typography mt={-2} sx={{ fontSize: 14 }}>
              ...
              projects and delivered impactful results through effective communication,
              collaboration, and my technical expertise. Developed core product features that drive
              user growth and retention, including AI-powered enhancements that streamline key user
              processes.
            </Typography>
          </AccordionDetails>
        </Accordion>
